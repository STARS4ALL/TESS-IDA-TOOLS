...
def add_args(parser: ArgumentParser) -> ArgumentParser:
    ...
    parser_single.add_argument(
        '-i', '--in-dir', type=str, default=None, help='IDA download files base directory')
    parser_single.add_argument(
    ...
    parser_range.add_argument('-i', '--in-dir', type=str,
                              default=None, help='IDA download files base directory')
    parser_range.add_argument(
        '-o', '--out-dir', type=str, default=None, help='Output IDA base directory')
    parser_range.add_argument('-sd', '--skip-download',
                              action='store_true', help='Skip download step')
    parser_range.add_argument('-on', '--out-filename', type=str,
